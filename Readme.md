...
在第三章中已经给出了所有指令的实现，值得注意的是，每条指令都有不同的时钟周期，
```
指令周期
...
这两个会在这一步的最后一节详细谈谈
```
所以第三章中代码有判定当前的地址和下一次地址是否在同一页的判定即当前地址的高8位和计算得到地址的高8位不一致，就表示页面交叉了，需要额外的时钟周期
而跳转的话，再JMP指令中也有相关的计算  

更多的指令请参考  
https://github.com/dustpg/BlogFM/issues/10

# 第六章 同第五章
本文参考  
https://zhuanlan.zhihu.com/p/44102262

# 第七章 同第六章
https://zhuanlan.zhihu.com/p/44158285

### 总结 
感觉CPU部分也是有很多的东西要理解，比如时钟周期等等，其实这部分感觉用硬件来理解可能更好，虽然已经知道了结果，毕竟是模拟器啊